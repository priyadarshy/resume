...
+ Helped implement an algorithm to extract breath rate from accelerometer data. 
...
+ I helped conceptualize, create and deliver multi-media content that captured concisely and in a captivating manner the essential features of the Aster nCluster. My work was invaluable in enhancing the market reach and appeal of Aster's product. In the process I gained experience working with massively-parallel databases, MapReduce, and data analysis. 
